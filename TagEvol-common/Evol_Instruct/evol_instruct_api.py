...
class EvolInstruct:
    def __init__(self, model_name) -> None:
        ...
        self.aclient = AsyncOpenAI(
            ...
            api_key="sk-4bb578ae1f884ee39e1b51ececfbf87c"
        )
    ...
    async def generate_responses(self, instructions: List[str], inputs: List[str], ids: List[str], temperature: float = 0, max_tokens: int = 2048) -> List[Dict[str, Any]]:
        ...
        results = [
            {
                "instruction": evol_outputs[i].strip(),
                "input": inputs[i],
                "output": "",
                "id":ids[i]
            }
...
async def main(model_name_or_path: str, source_file: str,
    ...
    """
    instructions, inputs, ids = get_evol_instructions(source_file, round_num, use_breadth)
...
if __name__ == "__main__":
    ...
    asyncio.run(main(args.model_name_or_path, args.source_file, args.target_file, args.round_num, args.temperature, args.max_tokens, args.debug, args.use_breadth, args.tp))
