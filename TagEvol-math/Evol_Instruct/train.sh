...
# for i in {0..3}
# do
#     data_path=/home/zhoushiqi/workplace/icaed/code/cot-instruct/Evol_Instruct/code_alpaca_20k-evol-roud${i}.json
#     dest_dir=/home/zhoushiqi/workplace/icaed/code/cot-instruct/Evol_Instruct/model/code_alpaca_20k-evol-roud${i}
...
deepspeed --master_port 25125 /home/zhoushiqi/workplace/icaed/code/cot-instruct/train_response.py \
    ...
    --data_path /home/zhoushiqi/workplace/icaed/code/cot-instruct/Evol_Instruct/code_alpaca_20k-evol-roud012.json \
    --output_dir /home/zhoushiqi/workplace/icaed/code/cot-instruct/Evol_Instruct/model/llama3/code_alpaca_20k-evol-roud012 \
    --full_determinism True\
    --num_train_epochs 3 \
    --model_max_length 2048 \
    --per_device_train_batch_size 8 \ \
