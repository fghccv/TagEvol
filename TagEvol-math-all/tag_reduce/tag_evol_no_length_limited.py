...
from prompt import generate_cgtags_prompt, generate_reduce_prompt, generate_evol_no_length_limited_prompt
...
class TagReduce:
    ...
    def tags_reduce_instruction(self, data_points, temperature, max_tokens, batch):
        ...
        for dk in tqdm.tqdm(data_points):
            ...
            # print(merge_tags)
            # input()
            all_instructions.append(generate_evol_no_length_limited_prompt(merge_tags, ori_instruction))
