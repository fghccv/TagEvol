...
def main(model_name_or_path: str, source_file: str,
    ...
    if os.path.exists(f"{tags_file}.cgtag_datas_70b.json"):
        print(f"{tags_file}.cgtag_datas_70b.json exsits")
        data_points = json.load(open(f"{tags_file}.cgtag_datas_70b.json"))
    else:
        print(f"{tags_file}.cgtag_datas_70b.json not exsits")
        data_points = engine.generate_tags(tags_datas, temperature, max_tokens)
        json.dump(data_points, open(f"{tags_file}.cgtag_datas_70b.json", 'w'))
    if os.path.exists(f"{source_file}.cgtag_datas_70b.json"):
        print(f"{source_file}.cgtag_datas_70b.json exsits")
        ori_data_points = json.load(open(f"{source_file}.cgtag_datas_70b.json"))
    else:
        print(f"{source_file}.cgtag_datas_70b.json not exsits")
        ori_data_points = engine.generate_tags(ori_datas, temperature, max_tokens)
        json.dump(ori_data_points, open(f"{source_file}.cgtag_datas_70b.json", 'w'))
