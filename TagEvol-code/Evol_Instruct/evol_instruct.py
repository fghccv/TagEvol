...
class EvolInstruct:
    ...
    def generate_responses(self, instructions: List[str], inputs: List[str], ids: List[str], temperature: float = 0, max_tokens: int = 2048) -> List[Dict[str, Any]]:
        """
...
def main(model_name_or_path: str, source_file: str,
    ...
    all_results = engine.generate_responses(instructions, inputs, ids, temperature, max_tokens)
