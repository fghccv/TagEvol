...
for batch in $(seq 20000 2 20000)
do
echo $batch
data_name=code_alpaca_20k_random-uncoupled_shot0_new_prompt2_fullbatch_newbatch
echo $data_name
pwd
conda activate apr
python3 tag_random_uncoupled_clean_newprompt_fullbatch.py \
