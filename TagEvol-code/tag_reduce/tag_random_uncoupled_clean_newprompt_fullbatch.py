...
class TagReduce:
    ...
    def tags_reduce(self, data_points, temperature, max_tokens, budget):
        import re,math
        from collections import defaultdict
        generate_data_points = defaultdict(dict)
        shot_ids = list(data_points.keys())
...
def main(model_name_or_path: str, source_file: str,
    ...
    generate_data_points = engine.tags_reduce(data_points, temperature, max_tokens, budget)
