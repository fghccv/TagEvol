...
model=/home/zhoushiqi/workplace/model/Meta-Llama-3-8B_ms
data_name=code_alpaca_20k_random-roud0-uncoupled_shot0
output_dir=./analys_datas/${data_name}
...
python ./analys_datas/merge_result.py --dir_name ${output_dir}
