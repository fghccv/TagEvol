        ...
        for batch_id in range(num_batch):
            ...
            while len(use_ids) > 0:
                ...
                for i in range(len(now_inputs)):
                    ...
                    try:
                        output = re.findall("```(.+?)```", output, re.DOTALL)[0]
...
def main(model_name_or_path: str, source_file: str,
    ...
    if os.path.exists("/home/zhoushiqi/workplace/icaed/code/cot-instruct/tag_reduce/code_alpaca_20k_tag_datas.json"):
        data_points = json.load(open("/home/zhoushiqi/workplace/icaed/code/cot-instruct/tag_reduce/code_alpaca_20k_tag_datas.json"))
    else:
        data_points = engine.generate_tags(ori_datas, temperature, max_tokens)
        json.dump(data_points, open("/home/zhoushiqi/workplace/icaed/code/cot-instruct/tag_reduce/code_alpaca_20k_tag_datas.json", 'w'))
