...
#     prompt = (
#         "You are a question generator capable of creating questions based on tags."
#         f"Below is a dictionary containing various types of tags:\n```json\n{json.dumps(merge_dict, indent=2)}\n```\n"
#         "You need to extract or generate a reasonable subset based on the above dictionary. The tags in this subset should be used to create a high-quality, challenging question.\n"
#         "Requirements:\n"
#         "1. The subset can be derived from the given dictionary, but you can also reasonably generate some **new tags** based on the current content.\n"
#         "2. While ensuring logical consistency(i.e., the selected tag subset can generate a reasonable question), try to include a variety types of tags.\n"
#         "3. For tags with similar meanings, you should merge them in a reasonable way.\n"
#         # "3. The subset should contain comprehensive and diverse information, covering all aspects that a task may involve."
#         "4. Only provide the subset; there is no need to provide the generated task.\n"
#         "Please reply strictly in the following format:\n```{}```"
#     )
#     return prompt
...
def generate_instruction_prompt(data_point):
    ...
    prompt = (
        "You are an instruction generator capable of creating high-quality, challenging instructions based on tags.\n"
        "Please imitate the way humans ask questions, generate a high-quality, challenging instruction based on the given tags.\n"
    ...
    prompt += f"# Example {len(shot_tags)+1}\n"
    prompt += f"## Tags:\n{json.dumps(sub_tags)}\n"
    prompt += "## Instruction:"
    # print(prompt)
    # input()
...
#     shot_tags, shot_instructions, sub_tags = data_point['shot_tags'], data_point['shot_instructions'], data_point['sub_tags']
#     prompt = (
#         "You are an instruction generator capable of creating high-quality, challenging code-related instructions based on tags.\n"
#         "Please imitate the way humans ask questions, generate a high-quality, challenging code-related instruction based on the given tags.\n"
#         "You need't generate the answer of the instruction, some input can be added if necessary, indicated by '###Input:'.\n"
#     )
#     for i, (tags, instruction) in enumerate(zip(shot_tags, shot_instructions)):
#         prompt += f"# Example {i+1}\n"
#         prompt += f"## Tags:\n{json.dumps(tags)}\n"
...
def generate_instruction_zero_prompt(data_point):
    ...
    prompt = (
        "You are an instruction generator capable of creating high-quality, challenging code-related instructions based on the given #Tags#.\n"
        "Please imitate the way humans ask questions, generate a high-quality, challenging code-related instruction based on the given #Tags#.\n"
        "Just provide the #Instruction# without any explanation.\n"
        "If the #Instruction# requires an input, provide the input after ‘#Input#’.\n"
