...
conda activate apr
data_name=tag_reduce-zeroshot_cr_newprompt2_input_Auto_evol-roud3
for i in {3..3}
do
  # echo $i
  # conda activate apr
  target_data_name=tag_reduce-zeroshot_cr_newprompt2_input_Auto_evol-roud${i}
  ...
  deepspeed --master_port 25125 ../train_response.py \
    ...
    --fp16 True\
    --shuffle True
  cd ../code-evaluate/eval && bash eval_epoch2.sh ${data_name}
